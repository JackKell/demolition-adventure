...
func _init() -> void:
	...
	idle_state.enter = _idle_enter
	idle_state.handle_input = _idle_input
...
func _on_stopped() -> void:
	...
	if tile.type == Tile.TileType.SPIKES or level.has_other_entities_at_coords(coords, self):
		bounce(face_direction)
		return
